...
# API key
API_KEY = "Cwyj1b7w949h0YGuq5FV5aZxv4bIxF8r9XkDs4Nv"
...
#I used OpenAI and Stackoverflow to help with this assignemnt. I also looked over the documentation to also help with this assignment